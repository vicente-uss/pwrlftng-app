...
export type Screen = 'login' | 'training' | 'create-routine' | 'edit-routine' | 'routine-detail' | 'active-session' | 'summary' | 'history' | 'session-detail' | 'profile' | 'exercise-library' | 'exercise-detail' | 'coach-athletes' | 'coach-athlete-detail' | 'coach-block-editor';
